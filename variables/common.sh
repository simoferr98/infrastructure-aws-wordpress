...
export TF_VAR_rds_01_scaling_configuration_db_autopause=false
...
export TF_VAR_appautoscaling_target_01_ecs_service_autoscaling_scale_in_cooldown=500
export TF_VAR_appautoscaling_target_01_ecs_service_autoscaling_scale_out_cooldown=500

export TF_VAR_usernamedb=simone123
export TF_VAR_passworddb=simone245